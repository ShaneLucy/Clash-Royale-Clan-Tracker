...
<html lang="en">
  ...
  <body>
    <nav
      class="navbar navbar-expand-lg navbar-light position-sticky font-weight-bold"
      style="background-color: #a7adc6; top: 0; z-index: 1;"
    >
      <button
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#clanStats" style="color: black;"
              >Clan Stats</a
            >
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#currentWar" style="color: black;"
              >Current War</a
            >
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#members" style="color: black;"
              >Members
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#warLog" style="color: black;"
              >War Log
            </a>
          </li>
        </ul>
        ...
        <div class="row pt-3">
          <div class="col-sm-12">
            <p class="font-weight-bold">
              ...
              <?php echo $calc->getDonationsPerWeek();?> Clan Badge ID:
    ...
    <section id="currentWar" class="secondary pb-5">
      <div class="container-fluid pt-5 pb-5">
        ...
        <div class="row pt-3">
          <div class="col-sm-12"><?php $calc->currentWarStatus(); ?></div>
        </div>
      </div>
    </section>
    ...
    <section id="members" class="pb-5">
      <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row pt-3">
          <div class="col-sm-12">
            <table class="w-100 large-screen-tables">
              <tr>
                <th class="sticky">Name</th>
                <th class="sticky">Role</th>
                <th class="sticky">Donations</th>
                <th class="sticky">Give - Request Ratio</th>
                <th class="sticky">Last Seen</th>
                <th class="sticky">Total Collection Battles Played</th>
                <th class="sticky">Final Battle Win/Loss Ratio</th>
                <th class="sticky">Final Battles Missed</th>
                <th class="sticky">War Participation</th>
                <th class="sticky">Cards Earned</th>
              </tr>
              <?php $calc->displayPlayerDetailsWideScreen();?>
            </table>
            <details class="small-screen-tables">
              <summary>
                Member Table Part 1:
              </summary>
              <table class="w-100 pb-2">
                ...
                <?php $calc->displayPlayerDetailsSmallScreen();?>
              </table>
            </details>

            <details class="pt-4 w-100 small-screen-tables">
              <summary>
                Member Table Part 2:
              </summary>
              <table class="w-100 pt-2">
                ...
                <?php $calc->displayPlayerDetailsSmallScreenTwo();?>
              </table>
            </details>

            <details class="pt-4 small-screen-tables">
              <summary>
                Member Table Part 3:
              </summary>
              <table class="w-100 pt-2">
                ...
                <?php $calc->displayPlayerDetailsSmallScreenThree();?>
              </table>
            </details>
          </div>
        </div>
          ...
          <div class="col-sm-12">
            <details class="pt-4 pb-4">
              ...
              <table class="w-100">
                <tr>
                  <th class="sticky">Name</th>
                  <th class="sticky">Collection Battles Played</th>
                  <th class="sticky">Cards Earned</th>
                  <th class="sticky">Allocated Final Battles</th>
                  <th class="sticky">Final Battles Played</th>
                  <th class="sticky">Final Battle Result</th>
                </tr>
                <?php $calc->warLog0();?>
              </table>
            </details>
