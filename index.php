...
<html lang="en">
  <head>
    ...
    <title>Sunday Roasts a Clash Royale Clan
    </title>
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#currentWar">Current War
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#warLog">War Log
              </a>
            </li>
          </ul>
        </div>
    ...
    <div id="particles-js">
      <h1 class="text-center pt-5">Sunday Roasts - A Competitive Clash Royale War Clan
      </h1>
    </div>
    ...
    <div class="overflow-auto container pt-5">
      <section id="currentWar">
        <h2 class="text-center pt-5">Current War
        </h2>
        <p class="pt-2">
    ...
    <section id="members">
      <div class="container pt-5">
        <h2 class="text-center pt-5">Members
        </h2>
      </div>
      <span class="pt-2">
      </span>
      ...
      <div class="container">
        <h3 class="text-center pt-5">Members Who Missed All Wars
        </h3>
        <?php $calc->missedAllWars();?>
        <h3 class="text-center pt-5">Members Eligible For Promotion
        </h3>
        <p>
          <?php $calc->promotionEligibility();?>
        </p>
        <h3 class="text-center pt-5">Members Eligible for Demotion
        </h3>
        <p>
    ...
    <section id="warLog" class="overflow-auto">
      <div class="container pt-5">
        <h2 class="text-center pt-5">War Log
        </h2>
        <span class="pt-2">
        </span>
        ...
        <details>
          ...
          <table>
            <tr>
              ...
              <th>Collection Battles Played
              </th>
              <th>Cards Earned
              </th>
              <th>Allocated Final Battles
              </th>
              <th>Final Battles Played
              </th>
              <th>Final Battle Result
              </th>
            </tr>
            <?php $calc->warLog0();?>
          </table>
